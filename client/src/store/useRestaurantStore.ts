...
const API_END_POINT = "https://full-stack-restaurant-app.onrender.com/api/v1/restaurant";
...
export const useRestaurantStore = create<RestaurantState>()(persist((set) => ({
    ...
    setAppliedFilter: (value: string) => {
        set((state) => {
            ...
            const updatedFilter = isAlreadyApplied ? state.appliedFilter.filter((item) => item.toLowerCase() !== value.toLowerCase()) : [...state.appliedFilter, value];
